                ...
                if (response != null) {
                    ...
                    for (int i = 0; i < pkmnGenDataList.getValue().size(); ) {
                        if (pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Normal") || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Incarnate")
                                ...
                                || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Galarian") || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Altered")
                                || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Land") || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Overcast")
                                || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("East_sea") || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Purified")
                                || pkmnGenDataList.getValue().get(i).get_pokemonForm().equals("Shadow")) {
                            i++;
                        } else {
